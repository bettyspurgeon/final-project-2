...
<div class="second-menu">
    ...
    <div id="modal-box" class="modal">
        ...
        <div class="modal-content delete-account">
            ...
            <div class="modal-text">
                ...
                <p>If you continue this action, all your account data will be lost! This includes information and any matches you have!</p>
                <div class="delete-act-btns">
                    <a href="{{'/deleteaccount/$user->id'}}"><button>Yes! Delete My Account</button></a>
                    <button>Actually, I want to stay</button>
                </div>
            </div>
        </div>
    ...
    <div class="manage-btn-container">
        ...
        <button type="button" onclick="location.href='/preferences/{{ $user->id }}' " class="manage-btn">Click to Manage Preferences</button>

            @if ( $user->type  == "landlord" || $user->type == "seller" )

            <button type="button" onclick="location.href='/preferences/{{ $user->id }}' " style="display: none">Click to Manage Preferences</button>

            @endif

            <button type="button" onclick="location.href='/user-profile/{{ $user->id }}' " class="manage-btn">Click to Manage My Documents and Information</button>
